...
help:
    ...
    @echo "  just balance AAPL         - Run balance_tracker for symbol AAPL (replace with your symbol)"
    @echo "  just test-balance AAPL    - Run balance_tracker for test symbol AAPL (replace with your symbol)"
